...
| `h3-prompts/` (folder) | MiniMax-H3 prompt toolkit: `build_h3_characters.py` (name-pool builder from the community known-characters index), `validate_scenes.py` (H3 prompt grammar checker incl. measured-banned camera phrases) + README with the full ref2va/full-reference format spec, draw mechanism, and provenance | `$HOME/Progetti/stream-h3/` | 2026-09-06 |
